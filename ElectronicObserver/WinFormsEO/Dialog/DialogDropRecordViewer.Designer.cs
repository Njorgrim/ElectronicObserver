namespace ElectronicObserver.WinFormsEO.Dialog
{
	partial class DialogDropRecordViewer
	{
		...
		private void InitializeComponent()
		{
			...
			this.LabelShipName = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.LabelItemName = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.LabelEquipmentName = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
