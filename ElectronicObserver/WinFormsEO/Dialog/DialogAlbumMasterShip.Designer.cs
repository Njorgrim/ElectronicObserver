...
namespace ElectronicObserver.WinFormsEO.Dialog
{
	partial class DialogAlbumMasterShip
	{
		...
		private void InitializeComponent()
		{
			...
			this.ResourceName = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.TableBattle = new System.Windows.Forms.TableLayoutPanel();
			this.TitleDayAttack = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.NightAttack = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.TitleNightAttack = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.DayAttack = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.AirSuperiority = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.TitleAirSuperiority = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.AlbumNo = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.imageLabel2 = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.Description = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.TableShipName = new System.Windows.Forms.FlowLayoutPanel();
			this.ShipType = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.ShipName = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.ShipID = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.TableRemodel = new System.Windows.Forms.TableLayoutPanel();
			this.RemodelAfterSteel = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.RemodelAfterAmmo = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.RemodelAfterLevel = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.RemodelAfterShipName = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.RemodelAfter = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.RemodelBeforeLevel = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.RemodelBeforeSteel = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.RemodelBeforeAmmo = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.RemodelBeforeShipName = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.RemodelBefore = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.TableConsumption = new System.Windows.Forms.TableLayoutPanel();
			this.Ammo = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.Fuel = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.TitleConsumption = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.TableParameterSub = new System.Windows.Forms.TableLayoutPanel();
			this.imageLabel76 = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.Rarity = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.Range = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.Speed = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.imageLabel72 = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.imageLabel71 = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.TitleRange = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.TitleSpeed = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.BuildingTime = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.TitleBuildingTime = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.TableArsenal = new System.Windows.Forms.TableLayoutPanel();
			this.PowerUpArmor = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.MaterialBauxite = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.PowerUpAA = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.MaterialFuel = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.PowerUpTorpedo = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.MaterialSteel = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.PowerUpFirepower = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.imageLabel60 = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.MaterialAmmo = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.imageLabel59 = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.TableEquipment = new System.Windows.Forms.TableLayoutPanel();
			this.Equipment5 = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.Aircraft5 = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.Equipment4 = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.Aircraft4 = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.Equipment3 = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.Aircraft1 = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.Equipment2 = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.Equipment1 = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.Aircraft3 = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.Aircraft2 = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.imageLabel45 = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.TableParameterMain = new System.Windows.Forms.TableLayoutPanel();
			this.LOSSeparater = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.FirepowerMax = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.EvasionSeparater = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.LOSLevel = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.imageLabel42 = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.TitleLuck = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.imageLabel41 = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.EvasionLevel = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.imageLabel40 = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.LuckMin = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.imageLabel39 = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.LuckMax = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.imageLabel38 = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.ParameterLevel = new System.Windows.Forms.NumericUpDown();
			this.imageLabel37 = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.LOSMax = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.imageLabel36 = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.LOSMin = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.imageLabel35 = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.EvasionMax = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.TitleParameterMax = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.ASWMax = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.ASWMin = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.ArmorMax = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.TitleParameterMin = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.AAMax = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.TitleLOS = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.TorpedoMax = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.ArmorMin = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.TitleHP = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.AAMin = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.HPMin = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.TorpedoMin = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.imageLabel3 = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.FirepowerMin = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.HPMax = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.TitleFirepower = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.TitleTorpedo = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.TitleAA = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.TitleArmor = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.TitleASW = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.TitleEvasion = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.ASWSeparater = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.ASWLevel = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.EvasionMin = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
