namespace ElectronicObserver.WinFormsEO.Dialog
{
	partial class DialogAlbumMasterEquipment
	{
		...
		private void InitializeComponent()
		{
			...
			this.AircraftCost = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.TitleAircraftCost = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.AircraftDistance = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.TitleAircraftDistance = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.AlbumNo = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.imageLabel1 = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			...
			this.EquipmentType = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.EquipmentName = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.EquipmentID = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			...
			this.Bomber = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.TitleBomber = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.LOS = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.ASW = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.imageLabel14 = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.TitleLOS = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.Armor = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.AA = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.Torpedo = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.Firepower = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			...
			this.Evasion = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.TitleAccuracy = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.Accuracy = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
