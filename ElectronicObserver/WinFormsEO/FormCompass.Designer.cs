namespace ElectronicObserver.WinFormsEO
{
	partial class FormCompass
	{
		...
		private void InitializeComponent()
		{
			...
			this.TextMapArea = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.TextDestination = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.TextEventKind = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.TextEventDetail = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			...
			this.TextEnemyFleetName = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.TextAirSuperiority = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.TextFormation = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
