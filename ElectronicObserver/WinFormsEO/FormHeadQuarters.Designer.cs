namespace ElectronicObserver.WinFormsEO
{
	partial class FormHeadquarters
	{
		...
		private void InitializeComponent()
		{
            ...
            this.HQLevel = new ElectronicObserver.WinFormsEO.Control.ShipStatusLevel();
            this.ShipCount = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
            this.EquipmentCount = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
            this.InstantRepair = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
            this.InstantConstruction = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
            this.DevelopmentMaterial = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
            this.ModdingMaterial = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
            this.FurnitureCoin = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
            this.DisplayUseItem = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
            ...
            this.Steel = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
            this.Bauxite = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
