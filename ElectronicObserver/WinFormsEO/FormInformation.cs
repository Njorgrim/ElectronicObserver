...
namespace ElectronicObserver.WinFormsEO
{
	...
	public partial class FormInformation : DockContent
	{
		...
		private string GetExpeditionResult(dynamic data)
		{
            ...
            sb.AppendLine(DynamicTranslator.Translator.GetTranslation(data.api_quest_name, Utility.TranslationType.ExpeditionTitle));
		...
		private string GetBattleResult(dynamic data)
		{
            ...
            sb.AppendFormat(GeneralRes.EnemyName + "\r\n", DynamicTranslator.Translator.GetTranslation(data.api_enemy_info.api_deck_name, Utility.TranslationType.OperationSortie));
