namespace ElectronicObserver.WinFormsEO.Integrate
{
	partial class FormIntegrate
	{
		...
		private void InitializeComponent()
		{
			...
			this.windowCaptureButton = new ElectronicObserver.WinFormsEO.Control.WindowCaptureButton();
			...
			this.windowCaptureButton.WindowCaptured += new ElectronicObserver.WinFormsEO.Control.WindowCaptureButton.WindowCapturedDelegate(this.windowCaptureButton_WindowCaptured);
			// 
			// infoLabel
			// 
