		...
		private class TableBaseAirCorpsControl : IDisposable
		{
			...
			public void Update(int baseAirCorpsID)
			{
				...
				else
				{
					...
					string areaName = KCDatabase.Instance.MapArea.ContainsKey( corps.MapAreaID ) ? DynamicTranslator.Translator.GetTranslation( KCDatabase.Instance.MapArea[corps.MapAreaID].Name, Utility.TranslationType.OperationMaps ) : "Unknown Area";
