namespace ElectronicObserver.WinFormsEO
{
	partial class FormBattle
	{
		...
		private void InitializeComponent()
		{
			...
			this.FormationFriend = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.Formation = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.FormationEnemy = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.AirStage2Friend = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.AACutin = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.AirStage2Enemy = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.AirStage1Enemy = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.SearchingFriend = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.Searching = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.AirStage1Friend = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.SearchingEnemy = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.AirSuperiority = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.FleetFriend = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.DamageFriend = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.FleetEnemyEscort = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.WinRank = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.DamageEnemy = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.FleetFriendEscort = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
			this.FleetEnemy = new ElectronicObserver.WinFormsEO.Control.ImageLabel();
